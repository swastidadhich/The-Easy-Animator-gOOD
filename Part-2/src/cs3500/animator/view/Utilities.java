...
public class Utilities {
  ...
  /**
   * Gets the last tick in the given model's directions.
   * @param directions model's shapes and motions
   * @return the last tick
   */
  protected int getLastTick(HashMap<Shape2D, List<Motion2D>> directions) {
    int lastTick = 0;
