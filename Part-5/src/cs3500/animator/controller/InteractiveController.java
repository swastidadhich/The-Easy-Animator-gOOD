...
/**
 * An interface for a controller of an interactive animation, allows interaction with the
 * animation with button presses and key presses, extends the AnimatorController interface.
 */
