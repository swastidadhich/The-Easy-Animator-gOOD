...
public class Motion2D implements IMotion2D {
   ...
   * @throws IllegalArgumentException if the name is null, tick1 is greater than tick2, the ticks,
   *                                  width, height, or color values are less than 0, the color
   *                                  values were greater than 255, tick1 equals tick2 but initial
   *                                  state differs from the final
   */
