...
public interface AnimatorModel {
   ...
   * @throws IllegalArgumentException if a shape with the given name has not been added, the
   *                                  motion's ticks overlaps with any current motions for that
   *                                  shape, the motion's starting tick is greater than its ending
   *                                  tick, the motion has a different state than another motion at
   *                                  a shared tick, the motion arguments are invalid
   */
  ...
  /**
   * Gets this model's last tick in its directions.
   *
   * @return the last tick
   * @throws IllegalArgumentException if the last tick is negative
   */
  int getLastTick() throws IllegalArgumentException;

  /**
   * Gets this model's first tick in its directions.
   *
   * @return the first tick
   * @throws IllegalArgumentException if the last tick is negative
   */
  int getFirstTick() throws IllegalArgumentException;
