...
public class Utilities {
  ...
  /**
   * Finds the new x and y positions, color, and dimensions of the given model shape with tweening
   * using the given motion and tick, and returns these newly tweened state as a view shape.
   *
   * @param s    model shape
   * @param m    motion
