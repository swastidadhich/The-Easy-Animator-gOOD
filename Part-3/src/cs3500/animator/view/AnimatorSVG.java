...
/**
 * An interface to represent a SVG view of an animation.
 */
public interface AnimatorSVG extends AnimatorView {

  /**
   * This is a helper method which helps with generating strings which help with generating the
   * shape and their attributes in the svg file.
   *
   * @param t1        tick1
   * @param t2        tick2
  ...
  /**
   * This is a helper method which helps with actually translating and getting the shapes to move,
  ...
  /**
   * This helper method helps in generating strings for the svg file for a circle and its attributes
   * (x = x-coordinate, y = y-coordinate, width & rbg).
   *
   * @param lom list of motions
   * @param id  identification tag for the shape
   * @return a string for the svg file
