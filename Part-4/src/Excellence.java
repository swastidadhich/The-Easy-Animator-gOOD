...
import cs3500.animator.provider.controller.ComplexAnimationController;
import cs3500.animator.provider.view.ComplexVisualAnimationView;
  ...
  public static void main(String[] args) throws IOException {
    ...
    switch (view) {
      ...
      case "provider":
        ...
        IComplexVisualAnimationView providerView = new ComplexVisualAnimationView();
        IAnimationController providerControl =
                new ComplexAnimationController(new ReadOnlyModel(model), providerView, (int) speed);
        providerControl.run();
        break;
      default:
        popUpError();
